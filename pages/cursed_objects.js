    ...
    return (
        <ScrollView>
            <View style={[style.options, (props.darkMode) ? style.bgDark : style.bgLight]}>
                <Text style={[{ textAlign: 'center', fontSize: 30 }, (props.darkMode) ? style.colorDark : style.colorLight]}>Objetos Amaldiçoados</Text>
                <View style={{ paddingTop: 15, alignItems: 'center' }}>
                    <Text style={[{ fontSize: 15, lineHeight: 25, textAlign: 'center' }, (props.darkMode) ? style.colorDark : style.colorLight]}>Existem ao todo 6 objetos amaldiçoados, onde apenas 1 irá aparecer aleatóriamente na missão. Cada objeto (com exceção das cartas) irá reduzir bastante sua sanidade e, caso chegue a 0%, o objeto se destrói e uma caçada amaldiçoada se iniciará.</Text>
                </View>
